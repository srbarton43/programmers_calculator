...
int main() {
  ...
  printf("\n");
  print_unsigned_decimal(&six_four);
  printf("\n");
  lshift(&number, &number, &six_four, 128);
  print_unsigned_decimal(&number);
  printf("\n");
  number_t one = {128, {0, 1}, {0}};
  print_unsigned_decimal(&one);
  printf("\n");
